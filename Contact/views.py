...
def send_email(to_email, subject, html_content):
    # Ajout d'une vérification pour s'assurer que from_email est défini et autorisé
    from_email = settings.DEFAULT_FROM_EMAIL
    if not from_email:
        print("Erreur : DEFAULT_FROM_EMAIL n'est pas défini dans les paramètres.")
        return "Erreur de configuration : DEFAULT_FROM_EMAIL manquant."
